...
public class Picture extends SimplePicture
{
  ...
  public void fixUnderwater()
  {
    ...
    for (int row = 0; row < pixels.length; row++) {
      for (int col = 0; col < pixels[0].length; col++) {
          Pixel myPixel = pixels[row][col];
          if (myPixel.colorDistance(averageColor) < maxDistance * tolerance) myPixel.setBlue(myPixel.getBlue() + 50);
          else myPixel.setBlue(myPixel.getBlue() - 50);
      }
    }
  }
  ...
  {
    Picture flower1 = new Picture("water.jpg");
